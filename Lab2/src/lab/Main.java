...
public class Main {
    ...
    public static void libraryOpen(){
        ...
        library.addPersonToRegister("Maciej", "Blazewicz", Getter.getDate("01-01-1930"), new Address("USA", "New York", "Broadway", 1, 1));
        library.addPersonToRegister("Joe", "Doe", Getter.getDate("01-01-1930"), new Address("France", "Paris", "Bagietkowa", 22, 29));
        library.addPersonToRegister("Justinian", "Kieren", Getter.getDate("7-11-2001"), new Address("Poland", "Warsaw", "Passy", 21, 2));
        ...
        library.addBookToRegister("Milo sc mil osc w anemone", Genre.Fantasy, Lang.English, 1, Getter.getDate("01-02-2012"));
        ...
        while (true){
            ...
            switch (option) {
                case 1 -> {
                    ...
                    book = Getter.getNaturalNumber("Type book ID (from second page): )", 0, library.bookRegister.size() - 1);
                ...
                case 7 -> {
                    ...
                    System.out.println(library.personRegister.get(library.personRegister.size()-1).personToString());
                }
